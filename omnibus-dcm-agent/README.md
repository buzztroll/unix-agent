...
```shell
$ bin/omnibus clean dcm-agent --purge
```
...
[vagrant@ubuntu...] $ cd dcm-agent
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build dcm-agent
```
